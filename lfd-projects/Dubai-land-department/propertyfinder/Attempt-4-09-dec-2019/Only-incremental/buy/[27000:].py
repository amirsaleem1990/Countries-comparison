...
links_to_scrap = links_to_scrap[27000:]
...
with open("errors_buy[27000:].pkl", "wb") as file:
	pickle.dump(errors, file)
with open("df_buy.pkl[27000:]", "wb") as file:
	pickle.dump(df, file)
with open("all_records_list_buy[27000:].pkl", "wb") as file:
