...
links_to_scrap = links_to_scrap[18000:21000]
all_records_list = []
errors = []
...
print(len(df))
with open("errors_rent[18000:21000].pkl", "wb") as file:
	pickle.dump(errors, file)
with open("df_rent[18000:21000].pkl", "wb") as file:
	pickle.dump(df, file)
with open("all_records_list_rent[18000:21000].pkl", "wb") as file:
