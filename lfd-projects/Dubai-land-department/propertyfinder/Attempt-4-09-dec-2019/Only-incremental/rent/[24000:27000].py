...
print(len(df))
with open("errors_rent[24000:27000].pkl", "wb") as file:
	pickle.dump(errors, file)
with open("df_rent[24000:27000].pkl", "wb") as file:
	pickle.dump(df, file)
with open("all_records_list_rent[24000:27000].pkl", "wb") as file:
