...
links_to_scrap = links_to_scrap[21000:24000]
all_records_list = []
errors = []
...
print(len(df))
with open("errors_rent[21000:24000].pkl", "wb") as file:
	pickle.dump(errors, file)
with open("df_rent[21000:24000].pkl", "wb") as file:
	pickle.dump(df, file)
with open("all_records_list_rent[21000:24000].pkl", "wb") as file:
