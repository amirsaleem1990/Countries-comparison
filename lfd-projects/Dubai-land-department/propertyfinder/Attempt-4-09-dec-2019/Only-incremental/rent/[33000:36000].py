...
links_to_scrap = links_to_scrap[33000:36000]
all_records_list = []
errors = []
...
print(len(df))
with open("errors_rent[33000:36000].pkl", "wb") as file:
	pickle.dump(errors, file)
with open("df_rent[33000:36000].pkl", "wb") as file:
	pickle.dump(df, file)
with open("all_records_list_rent[33000:36000].pkl", "wb") as file:
