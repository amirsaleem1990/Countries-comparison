...
for e, url in enumerate(all_adds_links[28001 : 30000]):
    print(e, end=", ")
    try:
...
with open("df[28001 : 30000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[28001 : 30000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[28001 : 30000].pkl", "wb") as file:
