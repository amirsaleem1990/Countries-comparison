...
for e, url in enumerate(all_adds_links[14001 : 16000]):
    print(e, end=", ")
    try:
...
with open("df[14001 : 16000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[14001 : 16000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[14001 : 16000].pkl", "wb") as file:
