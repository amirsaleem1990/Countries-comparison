...
for e, url in enumerate(all_adds_links[44001 : ]):
    print(e, end=", ")
    try:
...
with open("df[44001 : ].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[44001 : ].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[44001 : ].pkl", "wb") as file:
