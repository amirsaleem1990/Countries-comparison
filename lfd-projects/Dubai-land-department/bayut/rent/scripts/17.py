...
for e, url in enumerate(all_adds_links[34001 : 36000]):
    print(e, end=", ")
    try:
...
with open("df[34001 : 36000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[34001 : 36000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[34001 : 36000].pkl", "wb") as file:
