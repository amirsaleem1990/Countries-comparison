...
for e, url in enumerate(all_adds_links[20001 : 22000]):
    print(e, end=", ")
    try:
...
with open("df[20001 : 22000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[20001 : 22000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[20001 : 22000].pkl", "wb") as file:
