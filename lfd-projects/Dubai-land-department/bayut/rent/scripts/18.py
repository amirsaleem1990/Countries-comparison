...
for e, url in enumerate(all_adds_links[36001 : 38000]):
    print(e, end=", ")
    try:
...
with open("df[36001 : 38000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[36001 : 38000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[36001 : 38000].pkl", "wb") as file:
