...
for e, url in enumerate(all_adds_links[26001 : 28000]):
    print(e, end=", ")
    try:
...
with open("df[26001 : 28000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[26001 : 28000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[26001 : 28000].pkl", "wb") as file:
