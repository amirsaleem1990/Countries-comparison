...
for e, url in enumerate(all_adds_links[8001 : 10000]):
    print(e, end=", ")
    try:
...
with open("df[8001 : 10000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[8001 : 10000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[8001 : 10000].pkl", "wb") as file:
