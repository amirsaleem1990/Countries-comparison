...
for e, url in enumerate(all_adds_links[40001 : 42000]):
    print(e, end=", ")
    try:
...
with open("df[40001 : 42000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[40001 : 42000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[40001 : 42000].pkl", "wb") as file:
