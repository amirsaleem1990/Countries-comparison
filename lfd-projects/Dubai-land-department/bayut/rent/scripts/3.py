...
for e, url in enumerate(all_adds_links[6001 : 8000]):
    print(e, end=", ")
    try:
...
with open("df[6001 : 8000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[6001 : 8000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[6001 : 8000].pkl", "wb") as file:
