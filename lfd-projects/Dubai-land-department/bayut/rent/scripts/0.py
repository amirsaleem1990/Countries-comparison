...
for e, url in enumerate(all_adds_links[: 2000]):
    print(e, end=", ")
    try:
...
with open("df[: 2000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[: 2000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[: 2000].pkl", "wb") as file:
