...
for e, url in enumerate(all_adds_links[12001 : 14000]):
    print(e, end=", ")
    try:
...
with open("df[12001 : 14000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[12001 : 14000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[12001 : 14000].pkl", "wb") as file:
