...
for e, url in enumerate(all_adds_links[42001 : 44000]):
    print(e, end=", ")
    try:
...
with open("df[42001 : 44000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[42001 : 44000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[42001 : 44000].pkl", "wb") as file:
