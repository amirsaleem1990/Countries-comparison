...
for e, url in enumerate(all_adds_links[32001 : 34000]):
    print(e, end=", ")
    try:
...
with open("df[32001 : 34000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[32001 : 34000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[32001 : 34000].pkl", "wb") as file:
