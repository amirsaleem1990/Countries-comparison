...
for e, url in enumerate(all_adds_links[10001 : 12000]):
    print(e, end=", ")
    try:
...
with open("df[10001 : 12000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[10001 : 12000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[10001 : 12000].pkl", "wb") as file:
