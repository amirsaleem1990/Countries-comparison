...
for e, url in enumerate(all_adds_links[18001 : 20000]):
    print(e, end=", ")
    try:
...
with open("df[18001 : 20000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[18001 : 20000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[18001 : 20000].pkl", "wb") as file:
