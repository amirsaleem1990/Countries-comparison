...
for e, url in enumerate(all_adds_links[30001 : 32000]):
    print(e, end=", ")
    try:
...
with open("df[30001 : 32000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[30001 : 32000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[30001 : 32000].pkl", "wb") as file:
