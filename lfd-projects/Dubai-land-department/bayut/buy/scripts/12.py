...
for e, url in enumerate(all_adds_links[24001 : 26000]):
    print(e, end=", ")
    try:
...
with open("df[24001 : 26000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[24001 : 26000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[24001 : 26000].pkl", "wb") as file:
