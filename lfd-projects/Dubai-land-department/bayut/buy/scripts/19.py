...
for e, url in enumerate(all_adds_links[38001 : ]):
    print(e, end=", ")
    try:
...
with open("df[38001 : ].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[38001 : ].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[38001 : ].pkl", "wb") as file:
