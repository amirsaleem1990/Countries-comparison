...
for e, url in enumerate(all_adds_links[16001 : 18000]):
    print(e, end=", ")
    try:
...
with open("df[16001 : 18000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[16001 : 18000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[16001 : 18000].pkl", "wb") as file:
