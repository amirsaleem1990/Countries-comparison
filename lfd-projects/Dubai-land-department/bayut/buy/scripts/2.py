...
for e, url in enumerate(all_adds_links[4001 : 6000]):
    print(e, end=", ")
    try:
...
with open("df[4001 : 6000].pkl", "wb") as file:
    pickle.dump(df, file)
with open("errors[4001 : 6000].pkl", "wb") as file:
    pickle.dump(errors, file)
with open("all_records_list[4001 : 6000].pkl", "wb") as file:
