...
def initialize_ETL_DB_file():
		...
		conn = sqlite3.connect('/home/amir/github/LFD-projects/ETL-cash-egypt/15-nov-2019/ETL.db') 
...
def Push_to_sqlite(folder_name, df_sms_log, 
	...
	ab = folder_name.replace("phoneRawDataFile-", "").replace(".zip", "").split("-")[0]
	ID = ab[0]
...
def Push_to_sqlite_Master_table(folder_name, S_phone_battery_level, S_ip_address, S_device_info, S_storage_size):
	conn = sqlite3.connect('/home/amir/github/LFD-projects/ETL-cash-egypt/15-nov-2019/Master.db')
