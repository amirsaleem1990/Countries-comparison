...
def parsing_error(folder_name, file_name):
	try:
		with open("/home/amir/github/LFD-projects/ETL-cash-egypt/28-oct-2019/logs.pkl", "rb") as file:
	...
	if logs != existing_logs:
		with open("/home/amir/github/LFD-projects/ETL-cash-egypt/28-oct-2019/logs.pkl", "wb") as file:
