...
def parsing_error(folder_name, file_name):
	try:
		with open("/home/amir/github/LFD-projects/ETL-cash-egypt/6-nov-2019/logs.pkl", "rb") as file:
	...
	if logs != existing_logs:
		with open("/home/amir/github/LFD-projects/ETL-cash-egypt/6-nov-2019/logs.pkl", "wb") as file:
...
def calendar_events_func(folder_name, file_name):
	...
	try:
		if bool(eval(x)):
			...
			df_calendar_events.description = df_calendar_events.description.str.replace("<u>", "").str.replace("<b>", "").str.replace("</b>", "").\
								str.replace("\n", "").str.replace("</u>", "").str.replace("<br>", "")
			df_calendar_events.columns = ["title", "description", "allowReminders", "dTStart", "dTEnd", "allDay"]
		else:
