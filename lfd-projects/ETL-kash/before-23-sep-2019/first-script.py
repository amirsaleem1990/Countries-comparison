...
if len(df_sms_sent_log) == 0:
	df_sms_sent_log = pd.DataFrame({"count" : [""],
									"date" : [""]})
...
if len(df_sms_log) > 0:
    df_sms_log['ID'] = ["ID Aug 30" for i in range(len(df_sms_log))]
...
if len(df_outgoing_call_log) > 0:
    df_outgoing_call_log['ID'] = ["ID Aug 30" for i in range(len(df_outgoing_call_log))]
...
if len(df_accounts_list) > 0:
    df_accounts_list['ID'] = ["ID Aug 30" for i in range(len(df_accounts_list))]
...
if len(df_filter_app_log) > 0:
    df_filter_app_log['ID'] = ["ID Aug 30" for i in range(len(df_filter_app_log))]
...
if len(df_calendar_events) > 0:
    df_calendar_events['ID'] = ["ID Aug 30" for i in range(len(df_calendar_events))]
...
if len(df_location) > 0:
    df_location['ID'] = ["ID Aug 30" for i in range(len(df_location))]
...
if len(df_galary_data) > 0:
    df_galary_data['ID'] = ["ID Aug 30" for i in range(len(df_galary_data))]
...
if len(df_call_log) > 0:
    df_call_log['ID'] = ["ID Aug 30" for i in range(len(df_call_log))]
...
if len(df_contacts_list) > 0:
    df_contacts_list['ID'] = ["ID Aug 30" for i in range(len(df_contacts_list))]
...
if len(df_app_install_log) > 0:
    df_app_install_log['ID'] = ["ID Aug 30" for i in range(len(df_app_install_log))]
...
if len(df_ext_storage_files) > 0:
    df_ext_storage_files['ID'] = ["ID Aug 30" for i in range(len(df_ext_storage_files))]
...
if len(df_sms_sent_log) > 0:
    df_sms_sent_log['ID'] = ["ID Aug 30" for i in range(len(df_sms_sent_log))]
