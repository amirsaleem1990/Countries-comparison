...
def initialize_ETL_DB_file():
		...
		conn = sqlite3.connect('/home/amir/github/LFD-projects/ETL-cash-egypt/24-oct-2019/ETL.db') 
...
def Push_to_sqlite(folder_name, df_sms_log, 
	...
	conn = sqlite3.connect('/home/amir/github/LFD-projects/ETL-cash-egypt/24-oct-2019/Master.db')
	c = conn.cursor()
