...
os.system("rm /home/amir/ETL/23-sep-2019/*.db")
if input("Empty trash [y\\n]   ") == "y":
	os.system("del -rf ~/.local/share/Trash/files/*")
os.system("rm $(ls -d */)")

os.chdir("/home/amir/ETL/23-sep-2019")
...
for zip_file in zip_files_names:
	...
	conn = sqlite3.connect('/home/amir/ETL/23-sep-2019/ETL.db')  
	c = conn.cursor()
	# if_exists='append'
	...
	conn = sqlite3.connect('/home/amir/ETL/23-sep-2019/Master.db')  
	c = conn.cursor()
