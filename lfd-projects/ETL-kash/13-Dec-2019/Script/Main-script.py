import sys
sys.path.insert(0,'/home/amir/github/LFD-projects/ETL-kash/13-Dec-2019/Script')
import json
import zipfile
import os
import pickle
...
os.chdir("/home/amir/github/LFD-projects/ETL-kash/13-Dec-2019/raw_synced_data")
...
if incremental:
	...
	with open("/home/amir/github/LFD-projects/ETL-kash/13-Dec-2019/Script/data_processed_previously.pkl", "wb") as file:
