...
def initialize_ETL_DB_file():
		...
		conn = sqlite3.connect('/home/amir/github/LFD-projects/ETL-kash/13-Dec-2019/db/ETL.db') 
...
if not "ETL.db" in os.listdir("/home/amir/github/LFD-projects/ETL-kash/13-Dec-2019/db"):
...
def Push_to_sqlite_Master_table(folder_name, S_phone_battery_level, S_ip_address, S_device_info, S_storage_size):
	conn = sqlite3.connect('/home/amir/github/LFD-projects/ETL-kash/13-Dec-2019/db/Master.db')
